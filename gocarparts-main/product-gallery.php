            ...
            <div class="minicart__product">
                <div class="minicart__product--items d-flex">
                    <div class="minicart__thumb">
                        <a href="product-details.php"><img src="assets/img/product/small-product/product1.webp" alt="prduct-img" loading="lazy"></a>
                    </div>
                ...
                <div class="minicart__product--items d-flex">
                    <div class="minicart__thumb">
                        <a href="product-details.php"><img src="assets/img/product/small-product/product2.webp" alt="prduct-img" loading="lazy"></a>
                    </div>
                    <div class="minicart__text">
...
if ($result && $result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        $productTitle = htmlspecialchars($row['name']);
...
if (!$found) {
    ...
    <div style="max-width: 700px; margin: 20px auto; border: 2px solid #e74c3c; border-radius: 12px; font-family: Arial, sans-serif; background: #ffffff;">
        ...
        <table style="width: 100%; border-collapse: collapse; background: #fdfdfd;">
            ...
            <tr style="border-bottom: 1px dashed #e74c3c;">
                ...
                <td style="padding: 14px;">
                    <span style="color: #999;">---</span>
                    <span onclick="openpricePopup()" style="cursor:pointer; color: #e74c3c; font-weight: bold; margin-left: 10px;">
  ...
  <span onclick="openquotePopup()" style="background: #e74c3c; color: white; padding: 12px 20px; text-decoration: none; border-radius: 6px; font-weight: bold; cursor:pointer;">
    Request a Quote
  </span>
</div>
...
<div id="mileagePopup" style="display:none; position:fixed; top:0; left:0; width:100%; height:100%; background:rgba(0,0,0,0.5); z-index:9999; justify-content:center; align-items:center;">
  <div style="width:90%; max-width:850px; background:white; border-radius:12px; overflow:hidden; position:relative; display:flex; flex-wrap:wrap;">
    ...
    <div style="flex:1.2; padding:30px; min-width:320px;">
      ...
      <form onsubmit="return validatePopupForm()" method="POST" style="display:flex; flex-direction:column; gap:12px;"action="submit_mileage.php">
         <input type="text" name="name" placeholder="Enter your name*" required style="padding:10px; border:1px solid #ccc; border-radius:6px;">
            <input type="email" name="email" placeholder="Enter your email*" required style="padding:10px; border:1px solid #ccc; border-radius:6px;">
            <input type="text" name="contact_number" placeholder="Enter contact number*" required style="padding:10px; border:1px solid #ccc; border-radius:6px;">
            <input type="text" name="zipcode" placeholder="Enter ZipCode*" required style="padding:10px; border:1px solid #ccc; border-radius:6px;">
            <textarea name="notes" placeholder="Notes, VIN Number etc." style="padding:10px; border:1px solid #ccc; border-radius:6px;"></textarea>

            <input type="hidden" name="make" id="hiddenMakeMileage">
<input type="hidden" name="model" id="hiddenModelMileage">
<input type="hidden" name="category" id="hiddenCategoryMileage">
<input type="hidden" name="year" id="hiddenYearMileage">
<input type="hidden" name="submodel" id="hiddenSubmodelMileage">
...
<div id="pricePopup" style="display:none; position:fixed; top:0; left:0; width:100%; height:100%; background:rgba(0,0,0,0.5); z-index:9999; justify-content:center; align-items:center;">
  <div style="width:90%; max-width:850px; background:white; border-radius:12px; overflow:hidden; position:relative; display:flex; flex-wrap:wrap;">

    <!-- ❌ Close Button -->
    <span onclick="closepricePopup()" style="position:absolute; top:10px; right:15px; font-size:24px; cursor:pointer; color:#c0392b; z-index:10;">&times;</span>
    ...
    <!-- ✅ Right: Form -->
    <div style="flex:1.2; padding:30px; min-width:320px;">
      <h3 style="margin-top:0; color:#2c3e50;">Want the Exact Price? Submit Your Info & Our Team Will Call</h3>

      <form onsubmit="return validatepricePopupForm()" action="submit_price.php" method="POST" style="display:flex; flex-direction:column; gap:12px;">
    ...
    <input type="text" name="zipcode" placeholder="Enter ZipCode*" required style="padding:10px; border:1px solid #ccc; border-radius:6px;">
    <textarea name="notes" placeholder="Notes, VIN Number etc." style="padding:10px; border:1px solid #ccc; border-radius:6px;"></textarea>
        <input type="hidden" name="make" id="hiddenMakePrice">
<input type="hidden" name="model" id="hiddenModelPrice">
<input type="hidden" name="category" id="hiddenCategoryPrice">
<input type="hidden" name="year" id="hiddenYearPrice">
<input type="hidden" name="submodel" id="hiddenSubmodelPrice">
...
<div id="quotePopup" style="display:none; position:fixed; top:0; left:0; width:100%; height:100%; background:rgba(0,0,0,0.5); z-index:9999; justify-content:center; align-items:center;">
  <div style="width:90%; max-width:850px; background:white; border-radius:12px; overflow:hidden; position:relative; display:flex; flex-wrap:wrap;">

    <!-- ❌ Close Button -->
    <span onclick="closequotePopup()" style="position:absolute; top:10px; right:15px; font-size:24px; cursor:pointer; color:#c0392b; z-index:10;">&times;</span>
    ...
    <!-- ✅ Right: Form -->
    <div style="flex:1.2; padding:30px; min-width:320px;">
      <h3 style="margin-top:0; color:#2c3e50;">Want the Exact Report Quote? Submit Your Info & Our Team Will Call</h3>

      <form onsubmit="return validatequotePopupForm()" action="submit_quote.php" method="POST" style="display:flex; flex-direction:column; gap:12px;">
        <input type="text" name="name" placeholder="Enter your name*" required style="padding:10px; border:1px solid #ccc; border-radius:6px;">
        <input type="email" name="email" placeholder="Enter your email*" required style="padding:10px; border:1px solid #ccc; border-radius:6px;">
        <input type="text" name="contact_number" placeholder="Enter contact number*" required style="padding:10px; border:1px solid #ccc; border-radius:6px;">
        <input type="text" name="zipcode"  placeholder="Enter ZipCode*" required style="padding:10px; border:1px solid #ccc; border-radius:6px;">
        <textarea name="notes" placeholder="Notes, VIN Number etc." style="padding:10px; border:1px solid #ccc; border-radius:6px;"></textarea>
            <input type="hidden" name="make" id="hiddenMakeQuote">
<input type="hidden" name="model" id="hiddenModelQuote">
<input type="hidden" name="category" id="hiddenCategoryQuote">
<input type="hidden" name="year" id="hiddenYearQuote">
<input type="hidden" name="submodel" id="hiddenSubmodelQuote">
...
function openPopup() {
    ...
    // Set these values in the hidden inputs of the popup form
    document.getElementById("hiddenCategoryMileage").value = category;
document.getElementById("hiddenMakeMileage").value = make;
document.getElementById("hiddenModelMileage").value = model;
document.getElementById("hiddenYearMileage").value = year;
document.getElementById("hiddenSubmodelMileage").value = submodel;
...
function validatePopupForm() {
    ...
    closePopup();
    return true; // Prevent default form action for now
}
function openpricePopup() {
    ...
    // Set these values in the hidden inputs of the popup form
    document.getElementById("hiddenCategoryPrice").value = category;
document.getElementById("hiddenMakePrice").value = make;
document.getElementById("hiddenModelPrice").value = model;
document.getElementById("hiddenYearPrice").value = year;
document.getElementById("hiddenSubmodelPrice").value = submodel;
...
function validatepricePopupForm() {
    alert("Thank you! Our team will contact you soon.");
    closepricePopup();
    return true; // Prevent default form action for now
}
function openquotePopup() {
    ...
    // Set these values in the hidden inputs of the popup form
    document.getElementById("hiddenCategoryQuote").value = category;
document.getElementById("hiddenMakeQuote").value = make;
document.getElementById("hiddenModelQuote").value = model;
document.getElementById("hiddenYearQuote").value = year;
document.getElementById("hiddenSubmodelQuote").value = submodel;
...
window.addEventListener("DOMContentLoaded", function () {
  ...
  const selectedMake     = "<?php echo $make; ?>";
  const selectedModel    = "<?php echo $model; ?>";
  const selectedYear     = "<?php echo $year; ?>";
  const selectedSubmodel = "<?php echo $submodel; ?>";
  ...
  // Set category dropdown immediately
  if (selectedCategory) {
    categorySelect.value = selectedCategory;

    // Load the JS file for the category
    const scriptSrc = selectedCategory === "engines" ? "carData.js" : "transmission.js";
    ...
    script.onload = function () {
      ...
      // Populate Make
      makeSelect.innerHTML = `<option value="" disabled>Select Make</option>`;
      ...
      // Populate Year
      if (carData[selectedMake]?.[selectedModel]) {
        yearSelect.innerHTML = `<option value="" disabled>Choose Year</option>`;
      ...
      // Populate Submodel
      if (carData[selectedMake]?.[selectedModel]?.[selectedYear]) {
        submodelSelect.innerHTML = `<option value="" disabled>Select Submodel</option>`;
        carData[selectedMake][selectedModel][selectedYear].forEach(sub => {
          const opt = new Option(sub, sub);
          submodelSelect.appendChild(opt);
        });
        submodelSelect.disabled = false;
        submodelSelect.value = selectedSubmodel;
      }
