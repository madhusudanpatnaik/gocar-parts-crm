<!-- Start header area -->
                ...
                <div class="header__topbar--inner d-flex align-items-center justify-content-between">
                    <ul class="header__topbar--info d-none d-lg-flex">
                        <li class="header__info--list">
                            <a class="header__info--link" href="shop-list.php">STORES</a>
                        </li>
                        <li class="header__info--list">
                            <a class="header__info--link" href="shop-list.php">DELIVERY</a>
                        </li>
                        <li class="header__info--list">
                            <a class="header__info--link" href="privacy-policy.php">GUARANTEE</a>
                        </li>
                        <li class="header__info--list">
            ...
            <div class="container">
                <div class="main__header--inner position__relative d-flex justify-content-between align-items-center">
                    ...
                    <div class="main__logo">
                        <h1 class="main__logo--title"><a class="main__logo--link" href="index.php"><img class="main__logo--img" src="assets/img/logo/logo.jpg" alt="logo-img"></a></h1>
                    </div>
    ...
    <a href="index.php" class="header__menu--link">Home</a>
                                ...
                                <li class="header__menu--items mega__menu--items">
                                    <a class="header__menu--link" href="shop-list.php">Shop 
                                ...
                                <li class="header__menu--items">
                                    <a class="header__menu--link" href="blog-left-sidebar.php">Blog 
                            ...
                            <li class="header__account--items header__minicart--items">
                                <a class="header__account--btn minicart__open--btn" href="cart.php" data-offcanvas>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="22.706" height="22.534" viewBox="0 0 14.706 13.534">
                                     ...
                                     <span class="minicart__btn--text">My Cart <!-- <span class="minicart__btn--text__price">$0.00</span> --></span>
                                </a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="categories__menu ">
                        ...
                        <ul class="d-none d-lg-block">
                                <li class="categories__menu--items">
                                    <a class="categories__menu--link" href="shop-list.php"> 
                    ...
                    <div class="header__right--area d-flex justify-content-between align-items-center">
                        <div class="header__menu">
                            <nav class="header__menu--navigation">
                                <ul class="header__menu--wrapper d-flex">
                                    <li class="header__menu--items">
                                        <a class="header__menu--link text-white active" href="index.php">Home 
                                    ...
                                    <li class="header__menu--items mega__menu--items">
                                        <a class="header__menu--link text-white" href="shop-list.php">Shop 
                                    ...
                                    <li class="header__menu--items">
                                        <a class="header__menu--link text-white" href="blog-left-sidebar.php">Blog 
                                    ...
                                    <li class="header__menu--items">
                                        ...
                                        <ul class="header__sub--menu">
                                            <li class="header__sub--menu__items"><a href="about.php" class="header__sub--menu__link">About Us</a></li>
                                            ...
                                            <!-- <li class="header__sub--menu__items"><a href="portfolio.php" class="header__sub--menu__link">Portfolio Page</a></li> -->
                                            <!-- <li class="header__sub--menu__items"><a href="wishlist.php" class="header__sub--menu__link">Wishlist Page</a></li> -->
                                            <li class="header__sub--menu__items"><a href="privacy-policy.php" class="header__sub--menu__link">Privacy Policy</a></li>
                                            <li class="header__sub--menu__items"><a href="loginpage.php" class="header__sub--menu__link">Login Page</a></li>
                                        </ul>
                                    </li>
                                    <li class="header__menu--items">
            ...
            <div class="offcanvas__inner">
                <div class="offcanvas__logo">
                    <a class="offcanvas__logo_link" href="index.php">
                        <img src="assets/img/logo/logo.jpg" alt="Grocee Logo" width="158" height="36">
                    </a>
